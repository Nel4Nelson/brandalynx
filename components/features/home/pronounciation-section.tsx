        ...
        <>
            <section className="relative w-full bg-white py-12 sm:py-16 lg:py-20">
                <div className="w-full max-w-full mx-auto">
                    {/* Card Container with Shadow - Matching Testimonial Style */}
                    <div className="bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-100 py-12 sm:py-16 lg:py-20 px-6 sm:px-8 lg:px-12">
